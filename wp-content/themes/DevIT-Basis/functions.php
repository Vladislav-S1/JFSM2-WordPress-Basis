...
function jfsm2_setup() {
    ...
    get_template_part( 'classes/mail' );
}
...
function jfsm2_add_meta_box() {
    add_meta_box(
        'attachment_meta_box',       // $id
        'attachment',                  // $title
        'jfsm2_show_attachment_meta_box',  // $callback
        'devit_contact_form',                 // $page
        'normal',                  // $context
        'high'                     // $priority
    );
}
function jfsm2_show_attachment_meta_box() {
    global $post;
    global $wpdb;
...
function jfsm2_save_meta_fields(){
}
